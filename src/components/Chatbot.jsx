...
const Chatbot = () => {
  ...
  const mockOpeningMessage =
    "Hello there. I am Arnifi. Ask me anything you want related to business setup in Saudi Arabia and UAE.";
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setShowTyping(false);
      setMessages((prevMessages) => [
        { role: "assistant", body: mockOpeningMessage },
      ]);
    }, 2000);
  }, []);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      setMessages((prevMessages) => [
        ...prevMessages,
        { role: "assistant", body: mockResponsePrefix },
      ]);
    }, 3000);
  }, [waitingOnResponse]);

  return (
    <div className="w-screen mx-auto h-screen bg-gray-50 flex flex-col">
